...
👉 **Tab Navigation**: Navigate between sections like Home, Search, and Settings with ease using tab navigation.

👉 **Post Creation Screen for Uploading Media**: Upload video and image posts directly from the app with integrated media selection.

👉 **Settings Screen with Detailed Insights**: View account details and activity, including uploaded videos and follower count, for a personalized experience.
...
const videos = [
  {
    ...
    prompt:
      "Assistant a motivating AI driven video aimed at inspiring coding enthusiasts with simple language",
  },
  {
  ...
  },
  {
    ...
    prompt:
      "Assistant a heartwarming video following the travels of dalmatian dog exploring beautiful Italy",
  },
  {
  ...
  },
  {
    ...
    prompt: "Assistant a captivating video journey through Japan's Sakura Temple",
  },
  {
...
**Advance your skills with Next.js 14 Pro Course_tab**
